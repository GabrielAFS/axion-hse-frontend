...
export default function EditEmployerForm() {
  ...
  return (
    <>
      ...
      <ShowcaseCollapsible title="Financeiro" className="!p-6.5">
        <form
          action="#"
          className="*:mb-4.5 *:flex *:flex-col *:gap-4.5 *:xl:flex-row *:xl:items-end"
        >
          <fieldset className="*:w-full *:xl:w-1/3">
            ...
            <InputGroup id="vidas" label="Vidas" type="number" placeholder="" />
          </fieldset>
      ...
      <ShowcaseCollapsible title="Parametrizações" className="!p-6.5">
        <form
          action="#"
          className="*:mb-4.5 *:flex *:flex-col *:gap-4.5 *:xl:flex-row *:xl:items-end"
        >
      ...
      <ShowcaseCollapsible title="Alertas" className="!p-6.5">
        <form
          action="#"
          className="*:mb-4.5 *:flex *:flex-col *:gap-4.5 *:xl:flex-row *:xl:items-end"
        >
      ...
      <ShowcaseCollapsible title="Observações" className="!p-6.5">
        <form
          action="#"
          className="*:mb-4.5 *:flex *:flex-col *:gap-4.5 *:xl:flex-row *:xl:items-end"
        >
      ...
      <ShowcaseCollapsible title="Responsável pelo PCMSO" className="!p-6.5">
        <form
          action="#"
          className="*:mb-4.5 *:flex *:flex-col *:gap-4.5 *:xl:flex-row *:xl:items-end"
        >
      ...
      <ShowcaseCollapsible title="Contabilidades" className="!p-6.5">
        <form
          action="#"
          className="*:mb-4.5 *:flex *:flex-col *:gap-4.5 *:xl:flex-row *:xl:items-end"
        >
