...
import ContabilidadesTable from "../tables/contabilidades-table";
...
export default function ContabilidadesForm({ query = "", page = 1 }: Props) {
  const formHref = "/";

  return (
    <ShowcaseCollapsible title={"Contabilidades Parceiras"} className="!p-6.5">
      ...
      <ContabilidadesTable query={query} currentPage={page} />
